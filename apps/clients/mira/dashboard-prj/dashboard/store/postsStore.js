...
export const usePostsStore = defineStore('posts', () => {
  ...
  console.log("PostsStore BASE_URL: ", BASE_URL);
  ...
  */
  ...
  return { posts, getPlaceholderImage, loadPosts, getImageForPost, getPostById, deletePost, updatePostImage, cacheImage, getCachedImage, updatePostComments, getPostComments };
});
