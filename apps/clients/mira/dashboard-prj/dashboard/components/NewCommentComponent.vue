<template>
  <div>
    <q-card class="q-mt-md">
      <q-card-section>
        <span v-if="authenticatedUser" class="comment-text">Commenting as <router-link :to="{ name: 'admin-profile' }">{{ username }}</router-link>.</span>
        <span v-else class="comment-text">Commenting as a guest. 
          <router-link class="router-link" to="/signin"> Please sign in </router-link> </span>
