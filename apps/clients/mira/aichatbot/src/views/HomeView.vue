...
const asstEndPoint = document.location.hostname === 'localhost' ? localEndPoint : publicEndPoint

const endPoint = import.meta.env.VITE_OPENAI_API_KEY_MIRA
...
const fetchAnswer = async () => {
  try {
    ...
    const res = await fetch(asstEndPoint, {
      method: "POST",
      headers: {
