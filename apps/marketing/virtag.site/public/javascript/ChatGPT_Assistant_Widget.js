...
(function() {
  // const host = "http://localhost:3000/chat-gpt-asst/12345";
  const host = "chatbotfileserver/chat-gpt-asst/12345";
...
.introMessage {
  font-size: 16px; /* Increased font size for intro message */
  font-weight: bold;
  margin-bottom: 12px; /* Space below the intro message */
...
`;
  ...
  header.addEventListener('click', () => {
    ...
    container.style.height = isExpanded ? 'auto' : '60px';
