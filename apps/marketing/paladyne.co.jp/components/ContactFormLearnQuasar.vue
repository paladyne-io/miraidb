        ...
        <div class="row">
            <div class="col-md-12 center-text">
                ...
                <div class="section-title text-center">
                    <h2 class="title fz-48">{{ $t('learn_quasar_contact_page_heading') }}</h2>
                    <p class="sub-title">{{ $t('learn_quasar_contact_page_subtitle') }}</p>
                </div>
                <!-- Section Title End -->
...
export default {
    ...
    data() {
        return {
            ...
            subject_placeholder: this.$t('learn_quasar_email_subject_placeholder'),
            message_placeholder: this.$t('learn_quasar_email_message_placeholder') + " *",
            ...
            subject: this.subject_placeholder,
        }
    },
};
</script>
