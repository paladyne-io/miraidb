    ...
    <div class="cta-section section-padding-250">
        <div class="container text-center icon-up-down-animation">
            ...
            <div class="section-title text-center" data-aos="fade-up">
                <h2 class="title fz-34"> {{ $t('about_heading') }} </h2>
                <p class="sub-title">{{ $t('about_subtitle') }} </p>
            </div>
            <!-- Section Title End -->
           <NuxtLink to="/contact-us" class="btn btn-primary btn-hover-secondary">{{ $t('contact_us_label') }}</NuxtLink>
