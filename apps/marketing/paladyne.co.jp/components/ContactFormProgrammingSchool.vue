<template>
<div class="contact-form-section pt-5 px-3" :style="{backgroundColor: '#f8faff'}">
    <div class="container">
        <div class="row">
            <div class="col-md-12 center-text">
                <!-- Section Title Start data-aos="fade-up" -->
                <div class="section-title text-center">
                    <p class="title fz-24">{{ $t('programming_school_contact_page_heading') }}</p>
                    <p class="sub-title">{{ $t('programming_school_contact_page_subtitle') }}</p>
                </div>
                <!-- Section Title End -->
...
export default {
    methods: {
        checkForm: function (e) {
            ...
            if (this.name && this.email && this.message && email_validated) {
    ...
    data() {
        return {
            ...
            subject_placeholder: this.$t('programming_school_email_subject_placeholder'),
            message_placeholder: this.$t('programming_school_email_message_placeholder') + " *",
            ...
            subject: this.$t('programming_school_email_subject_placeholder')
        }
    },
};
</script>
