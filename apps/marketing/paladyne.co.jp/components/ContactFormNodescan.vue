        ...
        <div class="row">
            <div class="col-md-12 center-text">
                ...
                <div class="section-title text-center">
                    <h2 class="title fz-48">{{ $t('nodescan_contact_page_heading') }}</h2>
                    <p class="sub-title">{{ $t('nodescan_contact_page_subtitle') }}</p>
                </div>
                <!-- Section Title End -->
...
export default {
    ...
    data() {
        return {
            ...
            name: null,
            email: null,
            subject: 'Regarding Nodescan',
            message: null,
            email_validated: false,

            name_placeholder: this.$t('email_name_placeholder') + " *",
            email_placeholder: this.$t('email_address_placeholder') + " *",
            subject_placeholder: this.$t('nodescan_email_subject_placeholder'),
            message_placeholder: this.$t('nodescan_email_message_placeholder') + " *",
