...
<script>
    export default {
        components: {
            ...
            AboutDesign: () => import('@/components/AboutDesign'),
            ...
            DesignDirectionTextBox: () => import('@/components/DesignDirectionTextBox'),
        },

        head() {
            return {
                title: 'Paladyne Design Project Management'
            }
        },
    };
</script>
